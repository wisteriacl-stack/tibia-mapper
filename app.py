...
# Rutas de IA Advisor y mapa offline. Antes vivian en app_ai.py, un punto de
# entrada paralelo que launcher.py (usado por tibia-mapper.spec para el EXE)
# nunca importaba, asi que el EXE distribuido no tenia /api/ai/* ni /api/map/*.
from ai_routes import register_ai_routes  # noqa: E402
from map_routes import register_map_routes  # noqa: E402
